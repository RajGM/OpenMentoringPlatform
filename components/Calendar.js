...
export default function Calendar() {
    return (
<div className="middle fullHeight bg-white shadow-lg hover:shadow-xl transition duration-300 ease-in-out" style={{width:'500px',margin:'auto auto', padding:'10px'}}>
            ...
            <CalendarLink
                link={"Hackathon"}
                text={"https://calendar.google.com/calendar/u/0?cid=NzU5ZDcxOGZlY2Y5N2MzNWVkMGU4OTYyYTg5M2Q3YTM1YWYwOGM3MDA0NTg5MDhiYWE0NThjODdjODBjYTJjNUBncm91cC5jYWxlbmRhci5nb29nbGUuY29t"}
