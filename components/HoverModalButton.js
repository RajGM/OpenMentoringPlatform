...
export default function HoverModalButton() {
        ...
        <Menu>
            ...
            >
                ...
                >
                    ...
                    }} style={{width:'150px', marginLeft:'-10px'}}>Profile Page</button>
                </MenuItem>
                <MenuItem
                    onSelect={() => {
                        setIsOpen(false);
                ...
                >
                    <button onClick={signOut} style={{width:'150px', marginLeft:'-10px'}}>Sign Out</button>
                </MenuItem>   
