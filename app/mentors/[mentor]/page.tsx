                  ...
                  <ul class="space-y-4">
                    <li class="flex items-center gap-4">
                      ...
                      <div>
                        ...
                        <dl class="mt-0.5 space-y-px text-[10px] text-gray-600">
                          <div>
                            <dt class="inline">MBA</dt>
                          </div>
                        </dl>

                        <dl class="mt-0.5 space-y-px text-[10px] text-gray-600">
                          <div>
                            <dd class="inline">Year:2010-2014</dd>
                          </div>
                        </dl>
                      </div>
                    </li>
                    ...
                    <li class="flex items-center gap-4">
                      ...
                      <div>
                        ...
                        <dl class="mt-0.5 space-y-px text-[10px] text-gray-600">
                          <div>
                            <dt class="inline">MS in CS</dt>
                          </div>
                        </dl>

                        <dl class="mt-0.5 space-y-px text-[10px] text-gray-600">
                          <div>
                            <dd class="inline">Year:2008-2010</dd>
                          </div>
                        </dl>
                      </div>
                    </li>
                    ...
                    <li class="flex items-center gap-4">
                      ...
                      <div>
                        ...
                        <dl class="mt-0.5 space-y-px text-[10px] text-gray-600">
                          <div>
                            <dt class="inline">BSs in CS</dt>
                          </div>

                          <div>
                            <dt class="inline">Year:</dt>
                            <dd class="inline">2004-2008</dd>
                          </div>
                        </dl>
                      </div>
                    </li>
                ...
                <li>
                  <article class="flex items-end justify-between rounded-lg border border-gray-100 bg-white p-6">
                    <div class="flex items-center gap-4">
                      ...
                      <div>
                        <p class="text-sm text-gray-500">2018 Round A</p>
                    ...
                    <div class="inline-flex gap-2 rounded bg-green-100 p-1 text-green-600">
                      ...
                      <span class="text-xs font-medium"> $200k </span>
                    </div>
                  </article>
                </li>
                ...
                <li>
                  <article class="flex items-end justify-between rounded-lg border border-gray-100 bg-white p-6">
                    <div class="flex items-center gap-4">
                      ...
                      <div>
                        <p class="text-sm text-gray-500">2020 Early Stage</p>
                    ...
                    <div class="inline-flex gap-2 rounded bg-green-100 p-1 text-green-600">
                      ...
                      <span class="text-xs font-medium"> $500k </span>
                    </div>
                  </article>
                </li>
                ...
                <li>
                  <article class="flex items-end justify-between rounded-lg border border-gray-100 bg-white p-6">
                    <div class="flex items-center gap-4">
                      ...
                      <div>
                        <p class="text-sm text-gray-500">2021 Round C</p>
                    ...
                    <div class="inline-flex gap-2 rounded bg-green-100 p-1 text-green-600">
                      ...
                      <span class="text-xs font-medium"> $400k </span>
                    </div>
                  </article>
                </li>
                ...
                <li>
                  <article class="flex items-end justify-between rounded-lg border border-gray-100 bg-white p-6">
                    <div class="flex items-center gap-4">
                      ...
                      <div>
                        <p class="text-sm text-gray-500">2022 Round C</p>
                    ...
                    <div class="inline-flex gap-2 rounded bg-green-100 p-1 text-green-600">
                      ...
                      <span class="text-xs font-medium"> $800k </span>
                    </div>
                  </article>
                </li>
              </ul>
